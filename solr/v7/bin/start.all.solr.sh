...
do
    ...
    ssh swissbib@$host "cd $SOLR_RUN; ./solr start -c -s $SOLR_HOME -p 8080 -z 'sb-uzk1.swissbib.unibas.ch:2181,sb-uzk2.swissbib.unibas.ch:2181,sb-uzk3.swissbib.unibas.ch:2181'"
